...
open class StackViewContainer: UIView, UIScrollViewDelegate {
    ...
    private let backgroundColorContainerView = UIView(frame: CGRect.zero)
    ...
    private func indexOfArrangedSubview(_ subview: UIView) -> Int {
    ...
    private func relayoutContent(_ didUpdateContent: Bool) {
